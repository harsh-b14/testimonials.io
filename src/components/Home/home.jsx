...
const Home = () => {
    return (
        ...
        <div className="home-container" style={{borderRadius : "0 0 5rem 5em"}} >
            ...
            <h1 className="text text-white text-base sm:text-2xl md:text-4xl lg:text-6xl">Get testimonial from your <br/> customer  <span className='text-base spanText sm:text-1xl md:text-3xl lg:text-5.5xl'> → by<br/> professionals</span></h1>
