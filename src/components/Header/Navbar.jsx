...
export default function Navbar() {
    ...
    return (
        <>
            <nav className="w-5/6 lg:max-w-screen-lg max-w-screen-md h-16 navbar m-auto px-4 py-2 rounded-xl flex items-center justify-between text-base sm:text-sm md:text-tiny lg:text-base sticky-navbar " style={{
                ...
                <div className="hidden lg:flex bg-slate-500 h-12 mr-1 my-0.5 px-2 py-1 rounded-xl items-center justify-between w-4/5 text-white font-Evolventa" style={{
                ...
                {isMenuOpen && (
                    <div className="navLink absolute inset-x-0 top-0 z-50 origin-top-right transform p-2 transition lg:hidden" >
                        <div className="divide-y-2 divide-gray-50 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 " style={{ backgroundColor: "rgba(139, 148, 173, 1)",
                backdropFilter: "blur(30px)",
                boxShadow: "0px 0px 30px rgba(227, 228, 237, 0.2)", }}>
