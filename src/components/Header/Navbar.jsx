...
export default function Navbar(){
    return(
        <>
            <nav className="w-4/5 max-w-6xl h-16 m-auto px-4 py-2 rounded-lg flex items-center justify-between font-sans overflow-y-hidden  text-base sm:text-sm md:text-tiny lg:text-base" style={{backgroundColor : "rgba(139, 148, 173, 0.51)   "}}>
                <div className="flex justify-start items-center px-2 py-1 rounded-md w-1/5 ">
                        <Logo />
                </div>
                <div className="flex bg-slate-600 h-12 mr-1 my-0.5 px-2 py-1 rounded-lg items-center justify-between w-4/5 text-white" style={{backgroundColor : "rgba(3, 9, 32, 1)"}}>
                    <div className="mx-16">
